...
import com.ecommerce.orderservice.payload.ErrorDetails;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorDetails> handleBlogAPIException(ECommerceException exception, WebRequest request) {
        ErrorDetails error = new ErrorDetails(exception.getMessage(), request.getDescription(false));
